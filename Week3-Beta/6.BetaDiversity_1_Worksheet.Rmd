...
rm(list=ls())
getwd()
#setwd("cloud/project/AB2025_ALennon/Week3-Beta")
...
>This is having so much trouble switching directories. I am not sure what do do- it is in text format while I try to figure out why it will not switch. 
